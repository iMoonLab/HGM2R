...
from models import DGCNNCls as Model
...
@hydra.main(config_path=".", config_name="pt_dgcnn")
def main(cfg: DictConfig):
    if cfg.mark.startswith('mn40>abo'):
        ...
        best_ckpt_path = "/home2/fengyifan/code/OSR/Extract-Feature/cache/mn40__level_all__t2r8__pt1024_dgcnn/2022-10-19_10-58-08/ckpt.pth"
