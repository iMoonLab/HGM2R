...
from models import PointNetCls as Model
...
@hydra.main(config_path=".", config_name="pt_pointnet")
def main(cfg: DictConfig):
    if cfg.mark.startswith('mn40>abo'):
        # best_ckpt_path = "/home2/fengyifan/code/OSR/Extract-Feature/cache/mn40>abo__level_all__in__pt1024_pointnet/2022-10-17_12-20-31/ckpt.pth"
        best_ckpt_path = "/home2/fengyifan/code/OSR/Extract-Feature/cache/mn40>abo__level_all__ex__pt1024_pointnet/2022-10-17_13-08-01/ckpt.pth"
    elif cfg.mark.startswith('mn40>scanobjectnn'):
        # best_ckpt_path = "/home2/fengyifan/code/OSR/Extract-Feature/cache/mn40>scanobjectnn__level_all__nobg__pt1024_pointnet/2022-10-18_09-52-49/ckpt.pth"
        best_ckpt_path = "/home2/fengyifan/code/OSR/Extract-Feature/cache/mn40>scanobjectnn__level_all__bg__pt1024_pointnet/2022-10-18_09-42-16/ckpt.pth"
    elif cfg.mark.startswith('esb'):
        best_ckpt_path = "/home2/fengyifan/code/OSR/Extract-Feature/cache/esb__level_all__t2r8__pt1024_pointnet/2022-04-27_15-52-46/ckpt.pth"
    elif cfg.mark.startswith('ntu'):
        best_ckpt_path = "/home2/fengyifan/code/OSR/Extract-Feature/cache/ntu__level_all__t2r8__pt1024_pointnet/2022-04-27_23-00-09/ckpt.pth"
    elif cfg.mark.startswith('mn40'):
        best_ckpt_path = "/home2/fengyifan/code/OSR/Extract-Feature/cache/mn40__level_all__t2r8__pt1024_pointnet/2022-04-27_22-45-29/ckpt.pth"
        # best_ckpt_path = "/home2/fengyifan/code/OSR/Extract-Feature/cache/mn40__level_all__t2r8_rnd__pt1024_pointnet/2022-10-11_14-36-58/ckpt.pth"
        # best_ckpt_path = "/home2/fengyifan/code/OSR/Extract-Feature/cache/mn40__level_all__t2r8__pt2048_pointnet/2022-10-20_09-14-05/ckpt.pth"
        # best_ckpt_path = "/home2/fengyifan/code/OSR/Extract-Feature/cache/mn40__level_all__t4r6__pt1024_pointnet/2022-10-11_14-59-31/ckpt.pth"
        # best_ckpt_path = "/home2/fengyifan/code/OSR/Extract-Feature/cache/mn40__level_all__t4r6_rnd__pt1024_pointnet/2022-10-11_15-05-35/ckpt.pth"
        # best_ckpt_path = "/home2/fengyifan/code/OSR/Extract-Feature/cache/mn40__level_all__t6r4__pt1024_pointnet/2022-10-11_15-07-40/ckpt.pth"
        # best_ckpt_path = "/home2/fengyifan/code/OSR/Extract-Feature/cache/mn40__level_all__t6r4_rnd__pt1024_pointnet/2022-10-11_15-08-14/ckpt.pth"
        # best_ckpt_path = "/home2/fengyifan/code/OSR/Extract-Feature/cache/mn40__2set_test2__pt1024_pointnet/2023-10-03_13-26-12/ckpt.pth"
        # best_ckpt_path = "/home2/fengyifan/code/OSR/Extract-Feature/cache/mn40__2set_test1__pt1024_pointnet/2023-10-03_13-25-30/ckpt.pth"
    elif cfg.mark.startswith('abo'):
        best_ckpt_path = "/home2/fengyifan/code/OSR/Extract-Feature/cache/abo__level_all__t2r8__pt1024_pointnet/2022-10-16_15-59-07/ckpt.pth"
    setup_seed()
    modalit_cfg = {
        'pointcloud': {'n_pt': cfg.arch.n_pt}
    }
    # predefined
